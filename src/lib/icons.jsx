import { Copy, CopyCheck, ChevronRight, RotateCcw, GripVertical, Trash2, Info } from "lucide-react";
import { cx } from "./cx";
...
export function CheckIcon({ color = "currentColor", size = 15, className }) {
  return <CopyCheck color={color} size={size} className={cx("icon", className)} />;
}

export function ChevronRightIcon({ color = "currentColor", size = 12, className }) {
  return <ChevronRight color={color} size={size} strokeWidth={3} className={cx("icon", className)} />;
}

export function ResetIcon({ color = "currentColor", size = 16, className }) {
  return <RotateCcw color={color} size={size} className={cx("icon", className)} />;
}

export function GripIcon({ color = "currentColor", size = 14, className }) {
  return <GripVertical color={color} size={size} className={cx("icon", className)} />;
}
...
export function InfoIcon({ color = "currentColor", size = 14, className }) {
  return <Info color={color} size={size} strokeWidth={2.5} className={cx("icon", className)} />;
}
